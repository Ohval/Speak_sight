...
class LightColor {
  ...
  static const Color primaryLightShade = Color.fromARGB(24, 0, 0, 0);

  static const Color titleTextColor = Color.fromARGB(255, 0, 173, 150);
  ...
  static const Color iconColor = Color(0XFF28a745);
